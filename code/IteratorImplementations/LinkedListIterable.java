...
import MyLinkedListImplementation.MyLinkedList;

import java.util.Collection;
import java.util.Iterator;

public class LinkedListIterable implements Collection, Iterable{
    ...
    private class LinkedListIterator implements  Iterator {
        ...
        private MyNode tempHead;
        LinkedListIterable collection;

        LinkedListIterator(LinkedListIterable collection){
            this.collection = collection;
            tempHead = collection.head;
        }
