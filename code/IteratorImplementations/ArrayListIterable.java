...
public class ArrayListIterable implements Collection, Iterable {
    ...
    public boolean retainAll(Collection c) {
        ...
        ArrayListIterable newCollection = new ArrayListIterable();
    ...
    private class ArrayListIterator implements Iterator{
        ...
        public ArrayListIterator (ArrayListIterable arrayListIterable){
            this.array = arrayListIterable.toArray();
            index = 0;
        }
