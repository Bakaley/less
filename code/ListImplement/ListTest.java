...
public class ListTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Добавляем элемент -50 по индексу 5:");
        myCollection.add(5, -50);
        System.out.println(myCollection);
        ...
        collectionToRetain.add(1000);
        for (int i = 0; i < 5; i++) {
            collectionToRetain.add(ThreadLocalRandom.current().nextInt(-5, 5));
        }
        System.out.println("Добавляем элементы из другой коллекции после индекса 2:");
        collectionToRetain.add(1000);
        myCollection.addAll(2, collectionToRetain);
        System.out.println(myCollection);
